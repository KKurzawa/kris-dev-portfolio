...
const About = () => {
    return (
        <main className='flex flex-col md:flex-row items-center md:justify-evenly w-full h-fit md:h-[30rem] border-t-[1px] md:border-t-0 border-[#eed29ba8]'>
            <header className='welcome-message md:border-r-[3px] md:border-[#eed29be6]  bg-[#980D1C] flex flex-col w-full md:w-1/3 px-8 py-4 md:px-16 md:py-16 h-fit md:h-full justify-center'>
                ...
                <h1 className='kris-text text-5xl md:text-7xl py-1 text-start'>Kris <span className='kurzawa-text'>Kurzawa.</span></h1>
                <h2 className='description text-3xl md:text-4xl py-1 text-start'>I develop and design things for the web.</h2>
            </header>
            <article className="about md:border-l-[4px] md:border-l-[#980D1C] border-b-[3px] md:border-b-0 border-b-[#980d1bc2] border-t-[2px] md:border-t-0 border-t-[#841f29] w-full md:w-2/3 h-fit md:h-full p-8 lg:p-16 flex justify-center items-center text-md md:text-xl text-justify bg-[#eed29beb]">
