    ...
    return (
        <footer className='footer flex flex-col items-center bg-[#100607] text-[#eed29b]'>
            ...
            <article className='flex flex-col items-center text-sm md:text-md'>
                ...
                <button onClick={() => setTimeout(() => window.open('https://immense-everglades-74554-f9bad473782a.herokuapp.com/', '_blank'), 500)} className='webdev-link mb-4 md:mb-8'>Site Designed and Built by Kris Kurzawa</button>
            </article>
