...
const Landing = () => {
    return (
        <>
            {/* md and lg  */}
            <main className='landing-main-container hidden h-screen md:flex justify-center'>
            ...
            {/* sm  */}
            <main className='sm-landing-main-container h-screen flex justify-center md:hidden'>
